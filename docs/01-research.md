...
| G3 | FinOps for agents (token cost enforcement) ← **chosen: TokenGuard** |
...
1. **Agent Token-Budget Guard** ← chosen (TokenGuard)
2. MCP Security Scanner / Gateway (the emptiest market; folded into TokenGuard as Ring 3)
