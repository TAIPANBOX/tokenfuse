...
62. **A bearer credential is a door too, and it does not get to answer "is
    ...
    unassigned gap invariant 44 already records and 61 is reserved by a
    sibling branch in flight, PR #321, not merged at this file's own
    `verified_at`.) The MCP broker's two existing doors
