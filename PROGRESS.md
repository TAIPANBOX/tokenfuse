...
`cargo test --all` runs **1361 passing** (core 340, dpop 21, delegation 44,
gateway 731, cloud 224, umbrella 1, by `cargo test -p <crate>`), which is the figure the README badge
