...
`cargo test --all` runs **1223 passing** (core 309, dpop 16, delegation 41,
gateway 657, cloud 199, umbrella 1, by `cargo test -p <crate>`), which is the figure the README badge
