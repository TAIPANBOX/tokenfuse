...
`cargo test --all` runs **1078 passing** (core 300, dpop 16, delegation 34,
gateway 528, cloud 199, umbrella 1, by `cargo test -p <crate>`), which is the figure the README badge
