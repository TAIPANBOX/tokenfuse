...
`cargo test --all` runs **1133 passing** (core 300, dpop 16, delegation 41,
gateway 576, cloud 199, umbrella 1, by `cargo test -p <crate>`), which is the figure the README badge
