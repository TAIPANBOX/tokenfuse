...
`cargo test --all` runs **1244 passing** (core 314, dpop 20, delegation 41,
...
16 to 20 the same day: one characterization test recording that `ring`
already bounds an RSA modulus at 8192 bits (invariant 29), plus three more
