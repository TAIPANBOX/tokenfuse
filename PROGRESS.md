...
`cargo test --all` runs **1002 passing** (core 269, dpop 16, delegation 15,
gateway 502, cloud 199, umbrella 1, by `cargo test -p <crate>`), which is the figure the README badge
