...
> ```bash
> docker run -p 4100:4100 -e TOKENFUSE_ALLOW_STUB=1 ghcr.io/taipanbox/tokenfuse:v1.0.4
> ```
...
docker run -p 4100:4100 \
  ...
  ghcr.io/taipanbox/tokenfuse:v1.0.4
```
...
```bash
cosign verify ghcr.io/taipanbox/tokenfuse:v1.0.4 \
  --certificate-identity-regexp '^https://github.com/TAIPANBOX/tokenfuse/\.github/workflows/release\.yml@refs/tags/v' \
  --certificate-oidc-issuer https://token.actions.githubusercontent.com
gh attestation verify oci://ghcr.io/taipanbox/tokenfuse:v1.0.4 -R TAIPANBOX/tokenfuse
```
...
```bash
docker run -p 4100:4100 -e TOKENFUSE_ALLOW_STUB=1 ghcr.io/taipanbox/tokenfuse:v1.0.4   # gateway, offline
