...
- a new per-model rate column in the price book (contracts/tokenfuse-constants.json#price_book), such as cache_write_1h_per_mtok_microusd added in 1.0.1: a reader that knows the four original columns keeps reading them; a column is never removed or renamed within this major
